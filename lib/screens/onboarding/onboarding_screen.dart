...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  late AnimationController _floatController, _entranceController;
  late Animation<double> _floatAnim, _entranceScale, _entranceOpacity;
          ...
          child: Column(children: [
            ...
            Padding(
              ...
              child: Column(children: [
                ...
                FeevoButton(label: _pages[_currentPage].cta, onTap: _next),
              ]),
            ),
          ]),
        ),
                ...
                child: Transform.scale(
                    ...
                    child: Transform.translate(
                        ...
                        child: Container(
                            ...
                            child: Image.asset(page.catAsset,
                                width: 260,
                                height: 260,
                                fit: BoxFit.contain))))),
          ))),
      Expanded(
          ...
          child: Padding(
            ...
            child:
              ...
              Text(page.desc,
                  style: const TextStyle(
                      fontSize: 13, color: AppColors.textSecond, height: 1.8)),
            ]),
          )),
    ]);
  }
