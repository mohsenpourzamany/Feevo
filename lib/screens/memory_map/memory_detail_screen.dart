  ...
  Widget _buildContent(AppLocalizations l) {
    ...
    return ListView(
      ...
      children: [
          ...
          child: Row(children: [
            ClipRRect(
                ...
                child: m.albumArt != null
                    ? Image.network(m.albumArt!,
                        width: 80,
                        height: 80,
                        fit: BoxFit.cover,
                        errorBuilder: (_, __, ___) => _artFallback(m.moodEmoji))
            ...
            Expanded(
                child: Column(
                  ...
                  Row(children: [
                    _Badge(label: '${m.plays} ${l.plays}', emoji: '▶️'),
            ...
            AnimatedBuilder(
              ...
              builder: (_, __) => Transform.scale(
                  ...
                  child: Transform.translate(
                      ...
                      child: Image.asset(AppConstants.cat6,
        ...
        Row(children: [
          _StatCard(value: '${m.plays}', label: l.totalPlays, emoji: '▶️'),
          const SizedBox(width: 10),
          _StatCard(value: m.moodEmoji, label: l.mood, emoji: '🎭'),
          const SizedBox(width: 10),
          _StatCard(
        ...
        if (m.note != null) ...[
          Container(
            ...
            child:
              ...
              Text(m.note!,
                  style: const TextStyle(
                      fontSize: 12, color: AppColors.textSecond, height: 1.7)),
            ]),
          ),
          const SizedBox(height: 16),
        ],
          ...
          onTap: () async {
            try {
              final response = await http
                  .get(Uri.parse('https://api.deezer.com/track/${m.trackId}'));
