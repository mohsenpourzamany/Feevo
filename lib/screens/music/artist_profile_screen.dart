...
class _ArtistProfileScreenState extends State<ArtistProfileScreen>
  ...
  final List<String> _tabs = ['Popular', 'Similar'];
                    ...
                    : SlideTransition(
                        ...
                        child: FadeTransition(
                          ...
                          child: Column(children: [
                            ...
                            if (artist != null) _buildStats(artist),
                            const SizedBox(height: 16),
                            _buildTabs(),
    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
            ...
            colors: [Color(0xFF1a0a40), Color(0xFF0891B2), Color(0xFF4C1D95)]),
      ),
  ...
  Widget _buildActionButtons(DeezerArtist? artist) {
    return Padding(
  ...
  Widget _buildStats(DeezerArtist artist) {
    return Padding(
